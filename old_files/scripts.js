document.addEventListener("DOMContentLoaded", function () {
  ...
  var outdooractiveDE = L.tileLayer(
    "https://t0.outdooractive.com/portal/map/{z}/{x}/{y}.png",
    {
      name: "t0.outdooractive.com/portal/map", // Set the name property
    },
  );
  var outdooractiveAUT = L.tileLayer(
    "https://t0.outdooractive.com/austria/map/{z}/{x}/{y}.png",
    {
      name: "t0.outdooractive.com/austria/map", // Set the name property
    },
  );
  var outdooractiveST = L.tileLayer(
    "https://t0.outdooractive.com/suedtirol/map/{z}/{x}/{y}.png",
    {
  ...
  fetch("https://tile.opentopomap.org/")
    ...
    .catch((error) => {
      console.log(
        "An error occurred while checking the website availability:",
        error,
      );
    });
  ...
  configureButton.addEventListener("click", function () {
    if (
      ...
      configurationForm.style.display === ""
    ) {
